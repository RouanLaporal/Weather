...
if ("geolocation" in navigator) {
    geo.getCurrentPosition(function (position) {
        ...
        fetch(`http://api.weatherapi.com/v1/current.json?key=7a5e39162d0044c8972113559212709&q=${lat},${long}&aqi=yes`)
        ...
        fetch(`http://api.weatherapi.com/v1/forecast.json?key=7a5e39162d0044c8972113559212709&q=${lat},${long}&days=7&aqi=no&alerts=yes`)
            .then(response => response.json())
            .then(response => {
                for (var i = 1; i < 3; i++) {
